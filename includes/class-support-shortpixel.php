...
class NerdPress_Support_ShortPixel {
	...
	public function is_shortpixel_bulk_optimize_set() {
		...
		if ( ! isset( $options['shortpixel_bulk_optimize'] ) && ! Blog_Tutor_Support_Helpers::is_nerdpress() && defined( 'SHORTPIXEL_HIDE_API_KEY' ) ) {
	...
	public function hide_shortpixel_bulk_button() {
		...
		if ( ! isset( $options['shortpixel_bulk_optimize'] ) && $current_screen->id === 'settings_page_wp-shortpixel-settings' && ! Blog_Tutor_Support_Helpers::is_nerdpress()  && defined( 'SHORTPIXEL_HIDE_API_KEY' ) ) {
